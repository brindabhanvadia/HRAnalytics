...
Power BI Dashboard: Built an interactive dashboard integrating workforce metrics—employee count, attrition analysis (rates, breakdowns by demographics), job satisfaction, and productivity. Visualizations facilitate dynamic filtering to support executive HR use cases.


<img width="1166" height="653" alt="HR Analytics Dashboard PowerBI" src="https://github.com/user-attachments/assets/5ff22491-ae7c-4fa6-b5e5-df0374ee8c1a" />



Excel Dashboard: Assembled a comprehensive Excel dashboard with pivot tables and compelling charts, supplementing other tools and supporting ad hoc analysis.


<img width="1460" height="728" alt="HR Analytics Dashboard Excel" src="https://github.com/user-attachments/assets/d81415f0-3477-4449-9cc4-8e7d81255d7f" />


*Analytical Focus:*

Employee count and activity segmentation for workforce planning.
Attrition metrics compared to industry standards, with analysis segmented by gender, department, age, and education field.
Workforce demographics (average age, age distribution), supporting succession planning and diversity initiatives.
Identification of attrition root causes and actionable retention strategies using detailed breakdowns and interactive visualizations.
Job satisfaction measurement via ratings, driving engagement initiatives.

Outcome:
Unified HR analytics across multiple platforms, improved metric standardization, and enabled data-backed decision-making for recruitment, retention, and productivity enhancement. The project demonstrates strong expertise in integrating cross-platform data analysis tools and transforming raw HR data into executive-ready insights.
